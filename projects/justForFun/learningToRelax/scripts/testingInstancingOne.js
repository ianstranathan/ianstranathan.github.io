...
function main() 
{
	...
	gl.bufferData(gl.ARRAY_BUFFER, new Float32Array(unitCube), gl.STATIC_DRAW);
	let attribTypeNum = 3 // 3 floats
	const numVertices = 36;
	// const numVertices = 12;
	
	gl.enableVertexAttribArray(positionAttribLoc);
	gl.vertexAttribPointer(positionAttribLoc, attribTypeNum, gl.FLOAT, false, 0, 0);
