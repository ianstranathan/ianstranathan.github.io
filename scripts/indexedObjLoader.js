        ...
        switch(faces[ff].length)
        {
            ...
            case 4:
                ...
                for(let kk = 0; kk < faces[ff].length; kk++)
                {
                    ...
                    let vertTexIndex = Math.round(faces[ff][kk][1] - 1);
                    let vertNormIndex = Math.round(faces[ff][kk][2] - 1);

                    vertAttribArrayData.push(arrayOfVertPositions[vertPosIndex]); // push vert pos
                ...
                // Ex) 0 1 2
                //     0 2 3
                drawIndices.push(vertCount + 0);
                drawIndices.push(vertCount + 1);
                drawIndices.push(vertCount + 2);
                drawIndices.push(vertCount + 0);
                drawIndices.push(vertCount + 2);
                drawIndices.push(vertCount + 3);
